  ...
  <div style= "float: right; width: 100%; ; margin-top: 0%;position: fixed;margin-left: 2%;">
    ...
    <div class="logout">
     ...
     <div class="sidenav">
      ...
      <a style="background-color:#175176;color: white;" href="assignment.php">Allot Assignments</a>
    ...
    <div style="border: 1px solid black;width: 50%;height: 50%;position: fixed;margin-left: 33%;margin-top: 14%;background-color: #175176;border-radius: 5px;padding-left: 2%;" class="container">
      <select style="margin-left: 10%;margin-top: 2%;position: fixed;width: 25%;height: 5%;font-size: 20px;">
      ...
      <input style="margin-top: 10%;padding-left: 2%;margin-left: 18%;width:50%;font-size: 20px;" type="file" name="my_file" id="my-file">
    ...
    <h2 style="margin-left:50%; "> Allot Assignment</h2>
