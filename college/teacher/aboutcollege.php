  ...
  <div  class="header">
    <div style= "float: right; width: 100%; ; margin-top: -4%;position: relative;margin-left: 2%;">
      ...
      <div class="logout">
       ...
       <a href="teacher.php"><h2 style="margin-left: 84%;margin-top: -4%;color: white;font-size: 25px;text-decoration-line: underline;position: relative;">Profile</h2></a>

     </div>
     <h style="margin-left:50%;margin-top: -12%;font-size: 25px; "><b> College Information</b></h>

     <div class="sidenav">
      <a style="background-color:#175176;color: white;" href="aboutcollege.php">About College</a>
