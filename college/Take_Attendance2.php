  ...
  <form>
    <table>
     <tr>
         ...
         <td style="font-weight: bold;">Present/Absent</td>
     ...
     <tr>
       <td>PGI16CE001</td>
       <td>Abhinav Gaur</td>
       <td><input type="radio" id="Present" name="Present" value="Present">
           <input type="radio" id="Absent" name="Absent" value="Absent"></td>
